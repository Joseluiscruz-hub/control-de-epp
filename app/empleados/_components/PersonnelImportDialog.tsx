...
import type { ParsedPersonnelImport } from '@/lib/personnel-import';

export interface PersonnelImportDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  importFileName: string;
  importPreview: ParsedPersonnelImport | null;
  importingPersonnel: boolean;
...
export function PersonnelImportDialog({
  ...
  return (
    <Dialog
      ...
      onOpenChange={(isOpen) => {
        onOpenChange(isOpen);
        if (!isOpen && !importingPersonnel) onReset();
      }}
    >
